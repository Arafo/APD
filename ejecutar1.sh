...
java -cp bin practica1.Main -p 50 -t 0 -r 10 -a k -n 0 -u 0 -d 0 -fm grafos/relaciones50b.dat -fp grafos/productos50b.dat
# 10 repeticiones del algoritmo de Karger con el generador Random y con una matriz 100x100 de booleanos.
java -cp bin practica1.Main -p 100 -t 0 -r 10 -a k -n 0 -u 0 -d 0 -fm grafos/relaciones100b.dat -fp grafos/productos100b.dat
# 10 repeticiones del algoritmo de Karger con el generador Random y con una matriz 200x200 de booleanos.
java -cp bin practica1.Main -p 200 -t 0 -r 10 -a k -n 0 -u 0 -d 0 -fm grafos/relaciones200b.dat -fp grafos/productos200b.dat
# 10 repeticiones del algoritmo de Karger con el generador Random y con una matriz 500x500 de booleanos.
#java -cp bin practica1.Main -p 500 -t 0 -r 10 -a k -n 0 -u 0 -d 0 -fm grafos/relaciones500b.dat -fp grafos/productos500b.dat
...
java -cp bin practica1.Main -p 50 -t 0 -r 10 -a ks -n 0 -u 0 -d 0 -fm grafos/relaciones50b.dat -fp grafos/productos50b.dat
# 10 repeticiones del algoritmo de Karger-Stein con el generador Random y con una matriz 100x100 de booleanos.
java -cp bin practica1.Main -p 100 -t 0 -r 10 -a ks -n 0 -u 0 -d 0 -fm grafos/relaciones100b.dat -fp grafos/productos100b.dat
# 10 repeticiones del algoritmo de Karger-Stein con el generador Random y con una matriz 200x200 de booleanos.
java -cp bin practica1.Main -p 200 -t 0 -r 10 -a ks -n 0 -u 0 -d 0 -fm grafos/relaciones200b.dat -fp grafos/productos200b.dat
# 10 repeticiones del algoritmo de Karger-Stein con el generador Random y con una matriz 500x500 de booleanos.
#java -cp bin practica1.Main -p 500 -t 0 -r 10 -a ks -n 0 -u 0 -d 0 -fm grafos/relaciones500b.dat -fp grafos/productos500b.dat

# 10 repeticiones del algoritmo de Karger con el generador Random y con una matriz 4x4 de enteros.
java -cp bin practica1.Main -p 4 -t 1 -r 10 -a k -n 0 -u 1 -d 0 -fm grafos/relaciones4e.dat -fp grafos/productos4e.dat
...
java -cp bin practica1.Main -p 50 -t 1 -r 10 -a k -n 0 -u 1 -d 0 -fm grafos/relaciones50e.dat -fp grafos/productos50e.dat
# 10 repeticiones del algoritmo de Karger con el generador Random y con una matriz 100x100 de enteros.
java -cp bin practica1.Main -p 100 -t 1 -r 10 -a k -n 0 -u 1 -d 0 -fm grafos/relaciones100e.dat -fp grafos/productos100e.dat
# 10 repeticiones del algoritmo de Karger con el generador Random y con una matriz 200x200 de enteros.
java -cp bin practica1.Main -p 200 -t 1 -r 10 -a k -n 0 -u 1 -d 0 -fm grafos/relaciones200e.dat -fp grafos/productos200e.dat
# 10 repeticiones del algoritmo de Karger con el generador Random y con una matriz 500x500 de enteros.
#java -cp bin practica1.Main -p 500 -t 1 -r 10 -a ks -n 0 -u 1 -d 0 -fm grafos/relaciones500e.dat -fp grafos/productos500e.dat