...
java -cp bin practica1.Main -p 10 -t 1 -r 10 -a ks -n 0 -u 1 -d 0 -fm grafos/relaciones10e.dat -fp grafos/productos10e.dat
# 10 repeticiones del algoritmo de Karger con el generador SecureRandom y con una matriz 50x50 de enteros.
java -cp bin practica1.Main -p 50 -t 1 -r 10 -a ks -n 1 -u 1 -d 0 -fm grafos/relaciones50e.dat -fp grafos/productos50e.dat
# 10 repeticiones del algoritmo de Karger con el generador HighQualityRandom y con una matriz 100x100 de enteros.
java -cp bin practica1.Main -p 100 -t 1 -r 10 -a ks -n 2 -u 1 -d 0 -fm grafos/relaciones100e.dat -fp grafos/productos100e.dat
# 10 repeticiones del algoritmo de Karger con el generador XORShiftRandom y con una matriz 200x200 de enteros.
java -cp bin practica1.Main -p 200 -t 1 -r 10 -a ks -n 3 -u 1 -d 0 -fm grafos/relaciones200e.dat -fp grafos/productos200e.dat
